...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Create a dicom files samples filling tags with a factory library}
  spec.description   = %q{We need dicom files populated with the right tags to test and use it for DEMOs.
